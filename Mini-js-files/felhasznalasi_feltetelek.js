...
toggleLight.addEventListener("click", function () {
  ...
  if (moonIcon.classList.contains('hide-img')) {
    ...
    document.querySelectorAll('h3').forEach(el => el.style.color = '#ff8c00');
